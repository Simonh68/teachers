...
if(s.kind==='readalong'){
 ...
 if(!readerFrame){readerReady=false;readerFrame=document.createElement('iframe');readerFrame.title='Read Alone Text — קריאה מלווה של הסיפור המלא';readerFrame.src='read-along.html?v=integrated-1';$('#stage').replaceChildren(readerFrame);
