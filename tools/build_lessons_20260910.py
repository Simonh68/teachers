...
class Deck:
    ...
    def write(self):
        ...
        page = f'''<!doctype html>
<html lang="he" dir="rtl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#07111f"><title>{esc(self.title)} · {self.grade} · Teacher</title><link rel="stylesheet" href="{self.shared}deck.css?v=20260910b"></head>
