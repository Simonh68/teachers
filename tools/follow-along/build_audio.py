...
VOICE='en-US-BrianNeural' # Male narrator with a lightly raised pitch for a youthful reading.
PITCH='+10Hz'
...
async def main():
 ...
 c=edge_tts.Communicate(text,voice=VOICE,rate='+0%',pitch=PITCH,boundary='WordBoundary',proxy=os.environ.get('HTTPS_PROXY'))
