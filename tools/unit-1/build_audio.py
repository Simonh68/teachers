...
async def main():
 ...
 out=dict(audio='assets/narration.mp3?v=unit-1-v1',voice='en-US-BrianNeural',pitch='+10Hz',synthetic=True,sha256=hashlib.sha256(dest.read_bytes()).hexdigest(),sentences=clips)
